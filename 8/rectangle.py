...
class TestRectangle(unittest.TestCase):
    ...
    def test_from_points(self):
        self.assertEqual(Rectangle.from_points((Point(1, 2), Point(3, 4))), Rectangle(1, 2, 3, 4))
    ...
    def test_properties(self):
        self.assertEqual(Rectangle(1, 2, 3, 4).width, 2)
        self.assertEqual(Rectangle(1, 2, 3, 4).height, 2)
        self.assertEqual(Rectangle(1, 2, 3, 4).top, 2)
        self.assertEqual(Rectangle(1, 2, 3, 4).left, 1)
        self.assertEqual(Rectangle(1, 2, 3, 4).bottom, 4)
        self.assertEqual(Rectangle(1, 2, 3, 4).right, 3)
        self.assertEqual(Rectangle(1, 2, 3, 4).topleft, Point(1, 2))
        self.assertEqual(Rectangle(1, 2, 3, 4).topright, Point(3, 2))
        self.assertEqual(Rectangle(1, 2, 3, 4).bottomright, Point(3, 4))
        self.assertEqual(Rectangle(1, 2, 3, 4).bottomleft, Point(1, 4))
